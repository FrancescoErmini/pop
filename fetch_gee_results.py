...
from storage.assets_db import update_assets_done, get_assets_done
...
def fetch_gee_results():
    ...
    2. compare the assets names retrieved from cloud with the
        names retrieved from db ( names of asset already processed )
    ...
    for asset_name in assets_names_to_be_done:
        ...
        print("Found new  asset: " + asset_name)
